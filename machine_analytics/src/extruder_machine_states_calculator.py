...
def main():
    ...
    print("Time window: %s - %s (%d sec)" %
        (str(start_time_ts), str(end_time_ts),
         end_time_ts.value - start_time_ts.value))
    print("Time in Off state: %d sec" % result['off_state'])
    print("Time in On state: %d sec" % result['on_state'])
    print("Time in Ready state: %d sec" % result['ready_state'])
    print("Time in Purge state: %d sec" % result['purge_state'])
